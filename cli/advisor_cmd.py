...
def portfolio_advisor_measure_outcomes(
    ...
    """Measure outcomes for pending recommendations and shadow-book rows (daily cron).

    Delegates to outcome_tracker.compute_recommendation_outcomes for the
    recommendation log (alpha-relative QQQ scoring), then runs
    candidates.shadow_outcomes for shadow-book rows ≥30 days old.
    Prints a summary and human-override analysis."""
    _configure_logging(verbose)
    cfg = DEFAULT_CONFIG.copy()
    try:
        ...
        console.print(
            ...
            f"skipped_no_ticker={summary['skipped_no_ticker']}, "
        ...
        console.print(
            ...
            f"scored={shadow_summary['scored']}, "
            f"skipped_too_young={shadow_summary['skipped_too_young']}, "
